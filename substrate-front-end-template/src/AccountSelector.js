  ...
  if (!currentAccount) {
    return (
      <div className="logged-out-container">
        <h2 style={{ color: 'white' }}>Choose an account</h2>
        <div>
          {keyringOptions.map(option => (
            <div key={option.key} className="account-container">
              <div
                style={{
                  marginLeft: '15px',
                  marginRight: '10px',
              ...
              <div>
                <p className="name">{option.text.toLowerCase()}</p>
                <p className="address">{option.value}</p>
              </div>
